def helpMessage() {
    ...
    Mandatory arguments:
      ...
      --exp_platform                Indicator indicating the gene expression platform. HT12v3, HT12v4, HuRef8, RNAseq, AffyU219, AffyHumanExon, RNAseq_HGNC, RNAseq_ENTREZ.
...
process GeneExpressionQC {
    ...
    script:
      ...
      --contamination_slope ${contamination_slope} \
      --contamination_area ${contamination_area} \
      --emp_probe_mapping $baseDir/data/EntrezToEnsemblProbeMatching.txt \
      --output outputfolder_exp
      """
}
